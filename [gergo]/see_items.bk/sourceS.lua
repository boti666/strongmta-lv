...
function giveBadge(player, commandName, ...)
	if exports.see_groups:isPlayerLeaderInGroup(player, 1) or exports.see_groups:isPlayerLeaderInGroup(player, 13) or exports.see_groups:isPlayerLeaderInGroup(player, 12) then 
		if not (...) then
...
function useItem(item, additional, additional2)
	...
	elseif itemId == 390 then
		takeItem(source, "dbID", item.dbID)
		setElementData(source, "acc.premiumPoints", getElementData(source, "acc.premiumPoints") + 10000)
		exports.see_accounts:showInfo(source, "s", "10.000PP került az egyenlegedre!")
	elseif itemId == 391 then
		takeItem(source, "dbID", item.dbID)
		setElementData(source, "acc.premiumPoints", getElementData(source, "acc.premiumPoints") + 20000)
		exports.see_accounts:showInfo(source, "s", "20.000P került az egyenlegedre!")
	elseif itemId == 392 then
		takeItem(source, "dbID", item.dbID)
		setElementData(source, "acc.premiumPoints", getElementData(source, "acc.premiumPoints") + 50000)
		exports.see_accounts:showInfo(source, "s", "50.000PP került az egyenlegedre!")

	elseif itemId == 393 then
		takeItem(source, "dbID", item.dbID)
		exports.see_vehicles:createPermVehicle({
			modelId = 487,
			color1 = string.format("#%.2X%.2X%.2X", 200, 200, 200),
